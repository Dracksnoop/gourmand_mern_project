...
const navigate = useNavigate();
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900 px-4">
      <form onSubmit={loginSubmitHandler} className="w-full max-w-md p-6 md:p-8 rounded-xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-sm">
